<template>
  <div class="calender-wrap" @click.stop>
    <div class="calender">
      <div class="top">
        <CalendarIcon />
        <span v-show="selectedTime !== ''">{{ formatterDate(selectedTime) }}</span>
        <span v-show="selectedTime === ''" class="placeholder">{{ t('extraction.selectDate') }}</span>
      </div>

      <div class="title">
        <div class="btn" @click.stop="last()"><CalendarArrow /></div>
      ...
      <div class="bottom-btn">
        <button class="sure-btn" :class="{'disabled': selectedTime === ''}" @click.stop="firm">{{ t('extraction.customDate') }}</button>
      </div>
    </div>
  </div>
</template>
...
const emit = defineEmits<{
  (e: 'singleCheckedDate', date: string): void
}>()
...
const firm = () => {
  emit('singleCheckedDate', selectedTime.value)
}
